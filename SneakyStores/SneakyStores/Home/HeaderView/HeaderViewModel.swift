...
class HeaderViewModel {
    ...
    init() {
        footies = [
            ...
            HeaderModel(designerLogo: #imageLiteral(resourceName: "Adidas-logo-removebg-preview"), sneakerImage: #imageLiteral(resourceName: "addit-removebg-preview"), backgroundCellView: #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1), itemPrice: "$140", itemName: "Ladylag"),
            ...
            HeaderModel(designerLogo: #imageLiteral(resourceName: "fubu-removebg-preview"), sneakerImage: #imageLiteral(resourceName: "wed8-removebg-preview"), backgroundCellView: #colorLiteral(red: 0.7568627451, green: 0.6745098039, blue: 0.5843137255, alpha: 1), itemPrice: "$150", itemName: "Fubu Retro JI"),
